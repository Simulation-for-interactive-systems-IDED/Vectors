...
namespace MyMath
{
    public static class DrawVector2D
    {
        ...
        public static void DoDraw(Vector2D vector, Color color)
        {
            Debug.DrawLine(Vector3.zero, vector, color);
        }

        public static void DoDraw(Vector2D origin, Vector2D vector, Color color)
        {
        ...
        public static void Draw(this Vector2D vector, Color color)
        {
            DoDraw(vector, color);
        }
        ...
        /// </code>
        /// </example>
        public static void Draw(this Vector2D vector, Vector2D origin, Color color)
        {
